...
export function activate(context: vscode.ExtensionContext) {
    ...
    let config = vscode.workspace.getConfiguration('px2vworvh');
    ...
    let disposable = vscode.commands.registerTextEditorCommand('extension.px2vworvh', function (textEditor, edit) {
